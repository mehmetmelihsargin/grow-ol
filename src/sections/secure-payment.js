...
const data = {
  subTitle: 'ÖDEME GÜVENLİĞİ',
  title: 'Daha İyi Satın Alma',
  description:
    'Tek sayfa checkout yapısı sayesinde ziyaretçilerinizin müşteri olma oranlarını arttırın.',
  btnName: 'Daha Fazla Öğren',
  btnURL: '#',
};
