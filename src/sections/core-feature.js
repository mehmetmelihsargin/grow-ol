...
const data = {
  subTitle: 'Ana Özellikler',
  title: 'Hızlı Kullanıcı Deneyimi',
  features: [
    {
      id: 1,
      imgSrc: Briefcase,
      altText: 'Smart Features',
      title: 'Hızlı Sayfalar Arası Geçiş',
      text:
        'Ziyaretçileriniz sitenizde gezerken sayfalar arasında geçiş yaparken beklemeden diledikleri ürüne ulaşabilir.',
    },
    {
      id: 2,
      imgSrc: Secure,
      altText: 'Hızlı Filtre ve Arama Altyapısı',
      title: 'Hızlı Filtre ve Arama Altyapısı',
      text:
        'Potansiyel müşterileriniz aradığı ürünü sizin tanımladığınız özel alan, varyant gibi ürün özelliklerine göre hızlıca filtreleyebilir.',
    },
  ],
};
